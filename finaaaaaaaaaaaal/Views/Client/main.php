...
<body>
	...
	<!-- <div class="side-bar">
			...
			// foreach($show_loop as $l_i){
			 ?>
				<li><?php 
				//echo "seat: ".$l_i["Seat_Number"]."</br>"."Hall: ".$l_i["Hall_Number"]."</br>".$l_i["movie"];
				?></li>
			 ...
			 ?>
				...
				<div class="collapse navbar-collapse" id="navbarSupportedContent">
					<ul class="navbar-nav ml-auto">
						...
						<li class="nav-item">
							<a class="nav-link" href="savedtickets.php">Tickets</a>
						</li>
						<li class="nav-item">
							<a class="nav-link" href="book.php">Booking</a>
						</li>
						<li class="nav-item" style="background:#df0e62; border-radius:3px;">
					...
					<div class="search-right">
						<a href="search.php" class="btn search-hny mr-lg-3 mt-lg-0 mt-4" title="search">Search <span
					...
					<div class="Login_SignUp" id="login"
						...
						<!-- <li class="nav-item"> -->
						<!-- <a class="nav-link" href="../Auth/Login.php"><?php //echo $name ?><i class="fa fa-user-circle-o"></i></a> -->
						<!-- <i class="fa fa-user-circle-o"></i> -->
						<h2 class="profile"><i class="fa fa-user-circle-o"></i><?php echo "  ".$name ?></h2>
						<!-- </li> -->
					</div>
					<!-- <li class="nav-item">
				...
				<?php  
					...
					<div class="item vhny-grid">
						<div class="box16 mb-0">
							<a href="search_filter.php">
								<figure>
									<img style="height:300px;width:200px;" class="img-fluid" src="<?php echo $ml["image"]?>" alt="">
								</figure>
								<div class="box-content">
									<h4> <span class="post"><span class="fa fa-clock-o"> </span> <?php echo $ml["Movie_Type"]?>
						...
						<h3> <a class="title-gd" href="search_filter.php"><?php echo $ml["Movie_Title"]?></a></h3>
						<!-- <P><?php //echo $ml["Movie_Desc"]?><P> -->
						<div class="button-center text-center mt-4">
							<a href="search_filter.php" class="btn watch-button">show</a>
						</div>
