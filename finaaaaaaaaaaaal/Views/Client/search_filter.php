...
$fc= new fbc;
$uid=$_SESSION["userId"];
if(isset($_POST["watch-list-butt"]))
{
if($movie->insert_watch_list($uid,$_POST["idfield"])){
		...
		<div class="grids-main py-5">
			<div class="container py-lg-4">
				...
				<div class="w3l-populohny-grids">
					...
					// 	if(isset($_POST["watch-list-butt"]))
					// {
					// 	$movie->insert_watch_list($uid,$ml["Movie_id"]);
					// }
                    ?>
                   <div  class="card">
	<div style="border-radius:30px; " class="main_card">
		<div class="card_left">
			<div class="card_datails">
				...
				<input type="hidden" value="<?php echo $ml["Movie_id"]?>" name="idfield">
				<input type="submit" value="watch-list" name="watch-list-butt">
				</form>
				</div>
				<!-- <a href="https://www.imdb.com/title/tt4912910/" target="_blank">Read More</a> 19755-->
			<div style="" class="social-btn">
        <!-- WATCH TRAILER-->

				<!-- <button>
					<i class="fas fa-play"></i> Add To watch-list
				</button> -->
				<!-- GET-->
				<button >
					<i href="book.php" class="fas fa-download"></i> Book
                    <!-- <a href="book.php" target="_blank"> -->
				</button>
               ...
               $nameFeed=$fc->FeedbackOnFilm($ml["Movie_id"]);
				...
				?>
				<p style="font-size:20px;"><?php echo  $fdof["name"]." : ".$fdof["feedback"] ?><span style="color:black;font-weight:400;"><?php echo " Rate: ".$fdof["rate"]."/5" ?></span></p>
				<?php
				}
				// if(isset($_POST["watch-list-butt"]))
				// 	{
				// 		$movie->insert_watch_list($uid,$_POST["idfield"]);
				// 	}
				?>
			</div>	
			</div>
