		...
		<div class="grids-main py-5">
			<div class="container py-lg-4">
                ...
                <form  action="search.php" method="post">
                    <label for="">Get Your Movie</label>
                    <input class="searchbox-main"type="search" name="search-box-it" placeholder="search">
                    <input  class="search-btn" type="submit" value="search" name="search-it">
                 </form>
                 </div>
				<div class="w3l-populohny-grids">
                    ...
                    <!-- ---------------------------------------------------------------------------------------- -->
					<?php  
               // if(isset($_POST["search-it"])){
                if(isset($_POST["search-it"])){
                    $mov_loop=$movie->show_Movie_search($_POST["search-box-it"]);                        
